...
func _configure_buttons(theme: Theme, s: Dictionary) -> void:
	...
	_button_variation(theme, s, &"SecondaryButton", "button_secondary", "button_secondary_hover")
	_button_variation(theme, s, &"AccentButton", "button_accent", "button_accent_hover")
	_button_variation(theme, s, &"DangerButton", "button_danger", "button_danger_hover")
	_button_variation(theme, s, &"TabButton", "tab", "tab_selected")
...
func _button_variation(theme: Theme, s: Dictionary, name: StringName, normal: String, hover: String) -> void:
